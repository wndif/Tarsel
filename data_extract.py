...
if __name__ == "__main__":
    origin_path = "lshift_reg/lshift_reg_wadden_buggy2/report"
    target_path = "lshift_reg/lshift_reg_wadden_buggy2/extract"
        ...
        for fi in files:
            ...
            with open(origin_fname, 'r') as f:
                ...
                for i in range (0,len(lines)):
                    ...
                    if "Condition Coverage" in lines[i] and branch_end_flag == True:
                        branch_end = i - 2
                ...
                f2.close()
#                         wr_str += file_name[:-2] + "-" + key + " " + str(value) + "\n"
                    #print(f'dd:{statement_start}  ddd:{branch_start},  fff:{branch_end}')
        
# =============================================================================
#                 for s in lines: 
#                     if "File:" in s and filename_flag == True:
#                         #file_dict = {}
#                         index_l = s.find("Workspace") + 11
#                         index_r = s.find(".v") + 2
#                         file_name = s[index_l:index_r]
#                         print(file_name)
#                         filename_flag = False
#                     #elif "Toggle Coverage" not in s:
#                     elif "test" in file_name or "tb" in file_name or "TB" in file_name or "reader" in file_name or "writer" in file_name:
#                                 pass
#                     elif "Statement Details" in s:
#                         #加一行
#                         while(s != "\n"):
#                             line_number = eval(s[0:10])
#                             cover_type_str = s[10:30]
#                             exec_count_str = s[30:50]
#                             exec_count = 0
#                             try:
#                                 cover_type = eval(cover_type_str)
#                                 if "***0***" in exec_count_str:
...
#                             except SyntaxError:
#                                 pass
#                     elif "Branch Details" in s:
#                         if "Condition Coverage" not in s:
#                             if "IF Branch" in s:
# 
#                                 if "Branch totals" not in s:
#                                     if "All False Count" in s: pass
#                                     else:
#                                         line_number = eval(s[0:10])
#                                         cover_type_str = s[10:30]
#                                         exec_count_str = s[30:50]
