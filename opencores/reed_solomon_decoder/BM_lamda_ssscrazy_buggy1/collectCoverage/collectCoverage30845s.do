...
vsim -coverage RS_dec_tb +cover=sbcet -coveropt 1
run 30835ns
coverage clear
run 10ns 
coverage report -output report/v0/report30845.txt -srcfile=BM_lamda_ssscrazy_buggy1.v -detail -annotate -assert -directive -cvg -code {s b c e t}
quit -sim
quit -f